/*
        ...
        channel_adjuster :: adjust red/green/blue colour channels in an image
...
void channel_adjuster(unsigned char *image, int x_size, int y_size, 
        float red_factor, float green_factor, float blue_factor) {

        printf("Using channel_adjuster() implementation #1 - Naive (autovectorizable)\n");
